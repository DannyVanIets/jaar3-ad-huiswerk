namespace AD
{
        ...
        where T : System.IComparable<T>
    {
        ...
        // Voor proeftentamen 2013 gemaakt
        public T GeefEenNaKleinsteElement()
        {
            if (root != null)
            {
                BinaryNode<T> currentNode = root;
                BinaryNode<T> nearlySmallest = null;

                while (currentNode != null)
                {
                    if (currentNode.left != null && currentNode.data.CompareTo(currentNode.left.data) > 0)
                    {
                        nearlySmallest = currentNode;
                        currentNode = currentNode.left;
                    }
                    else if (currentNode.right != null)
                    {
                        ...
                        if (currentNode.left != null)
                        {
                            nearlySmallest = currentNode.left;
                            currentNode = nearlySmallest;
                        }
                        else
                        {
                            nearlySmallest = currentNode;
