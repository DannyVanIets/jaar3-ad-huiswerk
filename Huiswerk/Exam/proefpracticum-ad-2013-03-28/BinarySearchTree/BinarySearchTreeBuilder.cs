namespace AD
{
    public partial class DSBuilder
    {
        ...
        // Alles hieronder voor proeftentamen 2013 gemaakt.
        public static IBinarySearchTree<int> CreateBinarySearchTreeProeftoets2013()
        {
            BinaryNode<int> t3 = new BinaryNode<int>(6, null, null);
        ...
        public static IBinarySearchTree<int> CreateBinarySearchTreeProeftoets2013Zonder1()
        {
            BinaryNode<int> t3 = new BinaryNode<int>(3, null, null);
            BinaryNode<int> t4 = new BinaryNode<int>(4, t3, null);

            BinaryNode<int> t2 = new BinaryNode<int>(2, null, t4);
            BinaryNode<int> t8 = new BinaryNode<int>(8, null, null);
